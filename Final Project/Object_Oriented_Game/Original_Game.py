...
# Background
background = pygame.image.load('assets/spacebg.png')
...
for i in range(num_of_tie):
    tieImg.append(pygame.image.load('assets/tie.png'))
...
score_value = 0
font = pygame.font.Font('assets/freesansbold.ttf', 28)

textX = 10
textY = 10

# Game Over Text
over_font = pygame.font.Font('assets/freesansbold.ttf', 84)
